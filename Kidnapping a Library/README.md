...
## Description
Britain’s national library was held hostage by ransomware, and then it did the unthinkable: it published the details. This talk tells the story that the Library’s candor revealed--catastrophe, recovery, and lessons learned--with a modest dose of professional schadenfreude.

Most of the Library's post-mortem findings unsurprisingly reinforce the need to do better at reassuringly familiar best practices. We know how to reduce risk from ransomware. But the talk highlights a couple of unexpected wrinkles. The biggest vulnerability, for example, was legacy systems--but not for the usual reasons.
...
- [Rhysida Ransomware: In-Depth Analysis, Detection, Mitigation](https://www.sentinelone.com/anthology/rhysida/) (from Sentinel One)
